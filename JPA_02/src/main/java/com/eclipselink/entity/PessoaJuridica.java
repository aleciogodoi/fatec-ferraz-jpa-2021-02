...
public class PessoaJuridica extends Cliente {
	...
	public PessoaJuridica(int idCliente, String nome, 
	...
	public String toString() {
		return super.toString()+" - PessoaJuridica [inscricaoEstadual=" + inscricaoEstadual + ", inscricaoMunicipal=" + inscricaoMunicipal
